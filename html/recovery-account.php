...
<head>
  <!-- Title -->
  <title>Login Simple | Hubmoov</title>
      ...
      <div id="logoAndNav" class="container-fluid">
        ...
        <nav class="navbar navbar-expand u-header__navbar">
          ...
          <a class="d-flex d-lg-none navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-collapsed" href="index.html" aria-label="Front">
            ...
            <span class="d-inline-block u-header__navbar-brand-text">Hubmoo</span>
          </a>
          <!-- End Default Logo -->
        </nav>
        <!-- End Nav -->
      ...
      <div class="col-lg-5 col-xl-4 d-none d-lg-flex align-items-center gradient-half-primary-v1 height-lg-100vh px-0">
        <div class="w-100 p-5">
          ...
          <div id="testimonialsNavMain" class="js-slick-carousel u-slick mb-4"
            ...
            <div class="js-slide">
              ...
              <div class="w-md-80 w-lg-60 text-center mx-auto">
                <blockquote class="h5 text-white font-weight-normal mb-4"></blockquote>
              </div>
              <!-- End Testimonials -->
            </div>
          ...
          <div class="position-absolute right-0 bottom-0 left-0 text-center p-5">
            <h4 class="h6 text-white-70 mb-3">Hubmoov partners</h4>
        ...
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3 space-lg-0">
            ...
            <form class="js-validate mt-5">
              <!-- Title -->
              <div class="mb-7">
                <h2 class="h3 text-primary font-weight-normal mb-0">Recovery <span class="font-weight-semi-bold">Account</span></h2>
                <p></p>
              </div>
              <!-- End Title -->
              ...
              <div class="js-form-message form-group">
                <label class="form-label" for="signinSrEmail"> Email or phone </label>
                <input type="email" class="form-control" name="email" id="signinSrEmail" placeholder="Email address or Phone" placeholder="Phone Number" aria-label="Email address" required
              ...
              <div class="row align-items-center mb-5">
                <div class="col-6">
                  ...
                  <a class="small" href="/html/register.php">Sign up</a>
                  <span class="small text-muted"> Already have an account?</span>
                  <a class="small"href="/html/login.php" >Login</a>
                </div>

                <div class="col-6 text-right">
                  <button type="submit" class="btn btn-primary transition-3d-hover">send</button>
                </div>
              </div>
              <!-- End Button -->
            </form>
