...
<head>
  <!-- Title -->
  <title>Landing Job | Front - Responsive Website Template</title>
  ...
  <main id="content" role="main">
    ...
    <div class="position-relative">
      ...
      <div class="js-slick-carousel u-slick"
           ...
           data-infinite="true">
        <div class="js-slide">
          <div class="bg-img-hero min-height-620" style="background-image: url(../../assets/img/1920x800/img18.jpg);"></div>
        </div>
        <div class="js-slide">
          <div class="bg-img-hero min-height-620" style="background-image: url(../../assets/img/1920x800/img17.jpg);"></div>
        </div>
      </div>
      <!-- End Slick Carousel -->
      ...
      <div class="container position-absolute right-0 bottom-0 left-0 space-top-5 space-bottom-2">
        <!-- Info Link -->
        <a class="d-sm-inline-flex align-items-center bg-primary text-white shadow rounded-pill p-2 pr-3 mb-3" href="#">
          <span class="u-label u-label--sm u-label--white font-weight-semi-bold mr-3">Start Now</span>
              ...
              <div class="row">
                <div class="col-lg-5 mb-4 mb-lg-0">
                  ...
                  <label class="d-block">
                    ...
                    <small class="d-block text-secondary">job title, keywords, or company</small>
                  </label>
                  <div class="js-focus-state">
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Keyword or title" aria-label="Keyword or title" aria-describedby="keywordInputAddon">
                      <div class="input-group-append">
                ...
                <div class="col-lg-2 align-self-lg-end">
                  <button type="submit" class="btn btn-block btn-primary transition-3d-hover">Find Jobs</button>
                </div>
              </div>
              <!-- End Checkbox -->
            </form>
      ...
      <div class="card-deck d-block d-lg-flex card-lg-gutters-2">
        <div class="card card-frame transition-3d-hover mb-3">
          ...
          <a class="card-body" href="#">
            <div class="media">
              <div class="u-avatar">
                <img class="img-fluid rounded" src="../../assets/img/160x160/img6.jpg" alt="Image Description">
              </div>
              <div class="media-body px-4">
        ...
        <div class="card card-frame transition-3d-hover mb-3">
          ...
          <a class="card-body" href="#">
            <div class="media">
              <div class="u-avatar">
                <img class="img-fluid rounded" src="../../assets/img/160x160/img7.jpg" alt="Image Description">
              </div>
              <div class="media-body px-4">
        ...
        <div class="card card-frame transition-3d-hover mb-3">
          ...
          <a class="card-body" href="#">
            <div class="media">
              <div class="u-avatar">
                <img class="img-fluid rounded" src="../../assets/img/160x160/img8.jpg" alt="Image Description">
              </div>
              <div class="media-body px-4">
      ...
      <div class="card-deck d-block d-lg-flex card-lg-gutters-2 mb-9">
        <div class="card card-frame transition-3d-hover mb-3 mb-lg-0">
          ...
          <a class="card-body" href="#">
            <div class="media">
              <div class="u-avatar">
                <img class="img-fluid rounded" src="../../assets/img/160x160/img9.jpg" alt="Image Description">
              </div>
              <div class="media-body px-4">
        ...
        <div class="card card-frame transition-3d-hover mb-3 mb-lg-0">
          ...
          <a class="card-body" href="#">
            <div class="media">
              <div class="u-avatar">
                <img class="img-fluid rounded" src="../../assets/img/160x160/img10.jpg" alt="Image Description">
              </div>
              <div class="media-body px-4">
        ...
        <div class="card card-frame transition-3d-hover">
          ...
          <a class="card-body" href="#">
            <div class="media">
              <div class="u-avatar">
                <img class="img-fluid rounded" src="../../assets/img/160x160/img11.jpg" alt="Image Description">
              </div>
              <div class="media-body px-4">
    ...
    <div id="SVGbgElements5" class="svg-preloader position-relative gradient-half-primary-v1">
      <div class="container position-relative z-index-2 space-2 space-md-3">
        ...
        <div id="testimonialsNavPagination" class="js-slick-carousel u-slick u-slick--gutters-3 u-slick--pagination-interactive"
             data-infinite="true"
             data-slides-show="3"
    ...
    <div class="container space-2">
      <div class="js-slick-carousel u-slick"
        ...
        <div class="js-slide">
          <img class="u-clients" src="../../assets/svg/clients-logo/boring-company.svg" alt="Image Description">
        </div>
        <div class="js-slide">
          <img class="u-clients" src="../../assets/svg/clients-logo/google.svg" alt="Image Description">
        </div>
        <div class="js-slide">
          <img class="u-clients" src="../../assets/svg/clients-logo/embark.svg" alt="Image Description">
        </div>
        <div class="js-slide">
    ...
    <div id="SVGbgElements6" class="svg-preloader position-relative overflow-hidden">
      ...
      <figure class="position-absolute top-0 right-0 z-index-n1 w-100 h-100">
        <img class="js-svg-injector" src="../../assets/svg/components/bg-elements-6.svg" alt="SVG"
             data-parent="#SVGbgElements6">
      </figure>
      <!-- End SVG Background Element -->
    </div>
    ...
    <div class="container">
      ...
      <div class="row justify-content-lg-between align-items-md-center space-2">
        ...
        <div class="col-md-6 col-lg-5 text-md-right">
          <a class="btn btn-success btn-wide transition-3d-hover mb-1 mb-sm-0 mr-sm-1" href="../pages/signup-simple.html">Sign Up</a>
      ...
      <div class="row justify-content-md-between space-2">
          ...
          <ul class="list-unstyled mt-3 mb-0">
            <li class="mb-3">
              <a class="d-block bg-primary text-white shadow-primary-lg rounded-pill p-1" href="#">
                <div class="media align-items-center">
                  <span class="u-label u-label--sm u-label--white font-weight-semi-bold mr-2">23/05</span>
                  <div class="media-body">
            ...
            <li class="mb-3">
              <a class="d-block bg-primary text-white shadow-primary-lg rounded-pill p-1" href="#">
                <div class="media align-items-center">
                  <span class="u-label u-label--sm u-label--white font-weight-semi-bold mr-2">01/06</span>
                  <div class="media-body">
        ...
        <div class="col-sm-6 col-md-5 col-lg-3 order-lg-1">
          <div class="d-inline-flex align-self-start flex-column h-100">
            <!-- Logo -->
            <a class="d-flex align-items-center mb-3" href="../home/index.html" aria-label="Front">
            ...
            <!-- Copyright -->
            <p class="small text-white-70 mt-lg-auto mb-0">&copy; Front. 2018 Htmlstream.</p>
            <!-- End Copyright -->
          </div>
        </div>
      </div>
