        ...
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3 space-lg-0">
            ...
            <form class="js-validate mt-5">
              <!-- Title -->
              <div class="mb-7">
                <h1 class="h3 text-primary font-weight-normal mb-0">Welcome to <span class="font-weight-semi-bold">Hubmoov</span></h1>
                <p>Begin your experience</p>
              </div>
              <!-- End Title -->

              <!-- Form Group -->
              <form class="register" action="form.php" method="post">
              ...
              <label class="custom-control-label" for="termsCheckbox">
                <small>
                  I agree to the
                  <a class="link-muted" href="terms.html">Terms and Conditions</a>
                </small>
              </label>

              <div class="col-7 col-sm-11 text-right">
